...
class DBControl:
    def __init__(self, db_name):
        ...
        self.create_table("serial", "id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, path TEXT")
        self.create_table("season", "id INTEGER PRIMARY KEY AUTOINCREMENT, serial_id INTEGER, name TEXT, path TEXT")
        self.create_table("episode", "id INTEGER PRIMARY KEY AUTOINCREMENT, parent_id INTEGER, name TEXT, path TEXT")
    ...
    def insert_(self, table_name, columns, values): 
        req = f"INSERT INTO {table_name} ({columns}) VALUES (" + "?, " * (len(values) - 1) + "?)"
    ...
    def insert_ep(self, table_name, columns, name: str, path: str, parent_id: int):
        ...
        self.cursor.execute('''INSERT INTO episode (name, path, parent_id) VALUES (?, ?, ?)''', vals)
        self.conn.commit()
