...
class NeumorphismEffect(QtWidgets.QGraphicsEffect):
    originChanged = QtCore.Signal(QtCore.Qt.Corner)
    distanceChanged = QtCore.Signal(float)
    colorChanged = QtCore.Signal(QtGui.QColor)
    clipRadiusChanged = QtCore.Signal(int)

    _cornerShift = (QtCore.Qt.TopLeftCorner, QtCore.Qt.TopRightCorner, 
        QtCore.Qt.BottomRightCorner, QtCore.Qt.BottomLeftCorner)

    def __init__(self, parent=None, distance=4, color=None, origin=QtCore.Qt.TopLeftCorner, clipRadius=0):
    ...
    @QtCore.Slot(QtCore.Qt.GlobalColor)
...
class OutsideNeumorphismEffect(QtWidgets.QGraphicsEffect):
    ...
    def __init__(self, parent = None, distance: int = 6, lightColor: QtGui.QColor = QtGui.QColor("#EEEEEE"),
                 darkColor: QtGui.QColor = QtGui.QColor("#AAAAAA"), clipRadius: int = 20,
        ...
        self._radial = QtGui.QRadialGradient(.5, .5, .5)
        self._radial.setCoordinateMode(QtGui.QGradient.ObjectBoundingMode)
        self._conical = QtGui.QConicalGradient(.5, .5, .5)
        self._conical.setCoordinateMode(QtGui.QGradient.ObjectBoundingMode)
...
class InsideNeumorphismEffect(QtWidgets.QGraphicsEffect):
    ...
    def __init__(self, parent = None, distance: int = 3, lightColor: QtGui.QColor = QtGui.QColor("#EEE"),
